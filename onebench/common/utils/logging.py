...
# --------------------------------------------------------
# References:
# https://github.com/microsoft/superbenchmark/blob/main/superbench/common/utils/logging.py
# --------------------------------------------------------
...
class OneBenchLogger:
    """OneBench Logger class."""
    @staticmethod
    ...
    def create_logger(name, level=logging.INFO):
        ...
        OneBenchLogger.add_handler(logger, stream=sys.stdout, color=True)
        logger = LoggerAdapter(logger, extra={'hostname': socket.gethostname()})

        return logger


logger = OneBenchLogger.create_logger('onebench')
