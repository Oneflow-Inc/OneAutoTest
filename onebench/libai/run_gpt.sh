...
# dp8 zero2
bash tools/args_train.sh configs/gpt2_pretrain.py 1 8 0 127.0.0.1 1 1 true true true 16 128 true 2 220 100 24 16 1024 4096

#  1n8g 数据+模型并行   gpt2_nl24_nah16_hs1024_fp16_actrue_mp2_pp1_mb8_gb256_1n8g
bash tools/args_train.sh configs/gpt2_pretrain.py 1 8 0 127.0.0.1 2 1 true true true 8 128 false 0 220 100 48 16 1024 4096

#  1n8g 数据+模型并行   gpt2_nl24_nah16_hs1024_fp16_actrue_mp2_pp1_mb8_gb32_1n8g
bash tools/args_train.sh configs/gpt2_pretrain.py 1 8 0 127.0.0.1 2 1 true true true 8 32 false 0 220 100 48 16 1024 4096
