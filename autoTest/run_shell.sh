...
# ResNet50-accuracy
cd /ssd/oneTest/OneAutoTest/autoTest/scripts/models && git checkout dev_test_resnet50_accuracy
cd /ssd/oneTest/OneAutoTest/autoTest && bash examples/resnet50_graph_ddp_train.sh

# ResNet50-dlperf
#cd /ssd/oneTest/OneAutoTest/autoTest && bash examples/resnet50_graph_ddp_dlperf.sh


'''
# WDL
cd /ssd/oneTest/OneAutoTest/autoTest/scripts/models && git checkout main
cd /ssd/oneTest/OneAutoTest/autoTest
