...
sed -i 's/if self.iter == 1/if self.iter == 99/g' ./libai/engine/trainer.py
sed -i 's/hooks.PeriodicCheckpointer/#hooks.PeriodicCheckpointer/g' ./libai/engine/default.py
