...
LOG_FILENAME=$LOG_FOLDER/${TRAN_MODEL}_base_patch16_224_${AMP_OR}_ac${ACTIVATION_CHECKPOINT}_mp${MP}_pp${PP}_mb${MICRO_BATCH_SIZE}_gb${GLOBAL_BATCH_SIZE}_ap${AUTO_PARALLEL}_${NNODES}n${GPUS_PER_NODE}g_${RUN_TIME}
